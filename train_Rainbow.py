...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default="model/rainbow",
                        help='directory in which model should be saved')
    parser.add_argument('--log_dir', type=str, default="cmd_log/rainbow", help='directory in which logs should be saved')
