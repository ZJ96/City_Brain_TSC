...
class TestAgent():
    ...
    def load_roadnet(self, intersections, roads, agents):
        ...
        self.roads = roads
        self.agents = agents
        self.connect_intersections = self.get_around_inter(roads,agents)
    ...
    def _build_model(self,input_shape, action_space, dueling):
        ...
        model.compile(loss=huber_loss, optimizer=RMSprop(learning_rate=self.learning_rate))
        #model.summary()
        return model
    ...
    def get_around_inter(self, roads: dict, agents: dict):
    ...
    def get_all_states(self, observations_for_agent: dict):
        ...
        for agent_id in observations_for_agent.keys():
            ...
            for connet_inter in self.connect_intersections[agent_id]:
