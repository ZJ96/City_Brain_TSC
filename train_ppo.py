...
def train(agent_spec, simulator_cfg_file, gym_cfg, metric_period):
    ...
    for e in range(args.episodes):
        ...
        for agent_id in agent_id_list:
            tmp = all_data_buffer[agent_id]
            agent.set_buffer(tmp)
            actor_loss,critic_loss = agent.update()
            all_loss_actor+=actor_loss
            all_loss_critic+=critic_loss

        print("episode:{}/{},  actor_loss : {:.8f},  critic_loss : {:.8f} "
              .format(e, args.episodes ,all_loss_actor/args.steps,all_loss_critic/args.steps))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--steps', type=int, default=360, help='number of steps')  #360
